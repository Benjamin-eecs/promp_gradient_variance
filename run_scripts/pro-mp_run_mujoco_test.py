...
def main(config):
    ...
    trainer = Trainer(
        ...
        num_sapling_rounds = config['sampling_rounds']
    )
...
if __name__=="__main__":
    ...
    parser.add_argument('--dump_path', type=str, default=meta_policy_search_path + '/data/pro-mp/test_%d' % idx)

    args = parser.parse_args()
    args.dump_path = meta_policy_search_path + '/data/pro-mp/test_seed_%d' % args.seed
